...
{
    /// <summary>
    /// a node for the services that are running on the Kinly cluster
    /// </summary>
    public class Node
    {
        [Key]
        ...
        /// </summary>
        [Required, StringLength(30, ErrorMessage = "{0} length must be between {2} and {1}.", MinimumLength = 4)]
        public string Name { get; set; }
        /// <summary>
        /// This is the port number assigned to the node/service on the cluster (should be a valid port).
        /// </summary>
        [Required, RegularExpression("^([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])$", ErrorMessage = "Port Number is not valid")]
        ...
        /// </summary>
        public ICollection<NodeLabel> Labels { get; set; }
    }
}
